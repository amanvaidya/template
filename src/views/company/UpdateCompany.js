        ...
        <CCard>
          ...
          <CCardBody>
            <CRow>
              <CCol xl={6}>
                Company Name*
                <CInput name="compName" id="compName" placeholder="Company Name" onKeyPress={hideName}/>
                <p color="info" id="nmErr" style={{visibility: "hidden"}}>Please enter company address.</p>
              </CCol>
              <CCol xl={6}>
                Company Address*
                <CInput name="compAdd" id="compAdd" placeholder="Company Address" onKeyPress={hideAdd}/>
            ...
            <CRow>
              <CCol xl={6}>
                City*
                <CInput name="compCity" id="compCity" placeholder="City" onKeyPress={hideName}/>
                <p color="info" id="ctErr" style={{visibility: "hidden"}}>Please enter city.</p>
              </CCol>
              <CCol xl={6}>
                State*
                <CInput name="compState" id="compState" placeholder="State" onKeyPress={hideAdd}/>
            ...
            <CRow>
              <CCol xl={6}>
                Country*
                <CInput name="compCountry" id="compCountry" placeholder="Country" onKeyPress={hideName}/>
                <p color="info" id="conErr" style={{visibility: "hidden"}}>Please enter country.</p>
              </CCol>
              <CCol xl={6}>
                Pin*
                <CInput name="compPin" id="compPin" placeholder="Pin" onKeyPress={hideAdd}/>
            ...
            <CRow>
              <CCol xl={6}>
                Fax
                <CInput name="compFax" id="compFax" placeholder="Fax"/>
                <p color="info" style={{visibility: "hidden"}}>Please enter fax details</p>
              </CCol>
              <CCol xl={6}>
                Phone
                <CInput name="compPhone" id="compPhone" placeholder="Phone"/>
            ...
            <CRow>
              <CCol xl={6}>
                PAN
                <CInput name="compPan" id="compPan" placeholder="PAN"/>
                <p color="info" style={{visibility: "hidden"}}>Please enter PAN details</p>
              </CCol>
              <CCol xl={6}>
                GSTIN
                <CInput name="compGSTIN" id="compGSTIN" placeholder="GSTIN"/>
            ...
            <CRow>
              <CCol xl={6}>
                License Number
                <CInput name="compLicNum" id="compLicNum" placeholder="License Number"/>
            ...
            <CRow>
              ...
              <CCol xl={6}>
                SMTP Port
                <CInput name="compPort" id="compPort" placeholder="SMTP Port"/>
            ...
            <CRow>
              <CCol xl={6}>
              SMTP Email ID
              <CInput name="compEmail" id="compEmail" placeholder="SMTP Email Id"/>
              <p color="info" style={{visibility: "hidden"}}>Please enter Email Id</p>
              </CCol>
              <CCol xl={6}>
                SMTP Password
                <CInput name="compPass" id="compPass" placeholder="SMTP Password"/>
